...
require 'inc.con.php';
  ...
  if ( $_POST['action'] == "datatable") {
		...
		{
			  $sql = "SELECT confirm_voucher.voucher_id, confirm_voucher.client_name,confirm_voucher.email,confirm_voucher.contact_no from confirm_voucher where 1=1";
		$columns = array('confirm_voucher.voucher_id', 'confirm_voucher.client_name','confirm_voucher.email','confirm_voucher.contact_no');
		$isResult = $obj->generateDatatableView($sql, $columns, 'voucher_id');		
		echo $isResult;	
                }
...
$sql = "SELECT * FROM  confirm_voucher where voucher_id=:id";
...
$sql = "SELECT * FROM  voucher_hotel_meals where voucher_id=:id";
$param=array('id'=>$_REQUEST['id']);
$res = $obj->getRows($sql,$param);
...
$sql = "SELECT * FROM  voucher_itinerary where voucher_id=:id";
$param=array('id'=>$_REQUEST['id']);
$res = $obj->getRows($sql,$param);
