...
class db
{
    ...
    function connect( )
    {
        if ( $this->conn == null ) {
            try {
                 /* LOCALHOST*/
                 /*$this->conn = new PDO( 'mysql:host=localhost;dbname=northern_backoffice', 'root', '' );*/
                  /* SERVER*/
          $this->conn = new PDO( 'mysql:host=localhost;dbname=northern_backoffice', 'northern_office', 'officeuser' );
...
public function customdelete($sql)
    { try {
      ...
      /*
       ...
       print_r($totalData1);*/
        ...
        foreach ($totalData1 as $key => $value) {
            ...
            $outputData[] = '<a href="javascript:;" title="Edit('.$value[$index_column].')" class="btn btn-primary  edit" data-id="'.$value[$index_column].'"><i class=" icon-pencil"></i> </a> <a href="javascript:;" title="Delete('.$value[$index_column].')" class="btn btn-danger delete" data-id="'.$value[$index_column].'"><i class="icon-trash"></i> </a>';
            $data[] = $outputData;
        }
       $json_response = array(
            "draw" => intval($_REQUEST['draw']),
 ...
 public function generateDatatableCustom($sql, $columns, $index_column=""){
        $totalData = count($this->getRows($sql));
        $totalFiltered = $totalData; 
      ...
      /*
       ...
       print_r($totalData1);*/
        ...
        foreach ($totalData1 as $key => $value) {
            ...
            $outputData[] = '<a href="javascript:;" title="Occupy('.$value[$index_column].')" class="btn btn-primary  edit" data-id="'.$value[$index_column].'"><i class=" icon-check"></i> </a> <a href="javascript:;" title="Unblock('.$value[$index_column].')" class="btn btn-danger delete" data-id="'.$value[$index_column].'"><i class="icon-trash"></i> </a><a href="javascript:;" title="ViewNote('.$value[$index_column].')" class="btn btn-default note" data-id="'.$value[$index_column].'"><i class="icon-comment-alt"></i> </a>';
            $data[] = $outputData;
        }
       $json_response = array(
            "draw" => intval($_REQUEST['draw']),
...
public function generateDatatableAgentCustom($sql, $columns, $index_column=""){
        $totalData = count($this->getRows($sql));
        $totalFiltered = $totalData; 
      ...
      /*
       ...
       print_r($totalData1);*/
        ...
        foreach ($totalData1 as $key => $value) {
            ...
            $outputData[] = '<a href="javascript:;" title="Unblock('.$value[$index_column].')" class="btn btn-danger delete" data-id="'.$value[$index_column].'"><i class="icon-trash"></i> </a>';
            $data[] = $outputData;
        }
       $json_response = array(
            "draw" => intval($_REQUEST['draw']),
  ...
  public function generateDatatableEmailPrint($sql, $columns, $index_column=""){
        $totalData = count($this->getRows($sql));
        $totalFiltered = $totalData; 
        ...
        $sql .= " order by clientdetails.quot_id desc $sLimit ";
      ...
      /*
       ...
       print_r($totalData1);*/
        ...
        foreach ($totalData1 as $key => $value) {
            ...
            $outputData[] = '<a href="javascript:;" title="Email('.$value[$index_column].')" class="btn btn-primary  mail" data-id="'.$value[$index_column].'"><i class="icon-envelope"></i> </a> <a href="javascript:;" title="Print('.$value[$index_column].')" class="btn btn-warning  print" data-id="'.$value[$index_column].'"><i class="icon-print"></i> </a> <a href="javascript:;" title="Delete('.$value[$index_column].')" class="btn btn-danger delete" data-id="'.$value[$index_column].'"><i class="icon-trash"></i> </a><a href="javascript:;" title="Approve('.$value[$index_column].')" class="btn btn-default approve" data-id="'.$value[$index_column].'"><i class="icon-check"></i> </a>';
            $data[] = $outputData;
        }
       $json_response = array(
            "draw" => intval($_REQUEST['draw']),
...
public function generateDatatableView($sql, $columns, $index_column=""){
        $totalData = count($this->getRows($sql));
        $totalFiltered = $totalData; 
        ...
        $sql .= " order by confirm_voucher.voucher_id desc $sLimit ";
      ...
      /*
       ...
       print_r($totalData1);*/
        ...
        foreach ($totalData1 as $key => $value) {
            ...
            $outputData[] = ' <a href="javascript:;" title="View('.$value[$index_column].')" class="btn btn-warning  view" data-id="'.$value[$index_column].'"><i class="icon-eye-open"></i>  View</a> ';
            $data[] = $outputData;
        }
       $json_response = array(
            "draw" => intval($_REQUEST['draw']),
     ...
     public function generateDatatableAgentEmailPrint($sql, $columns, $index_column=""){
        $totalData = count($this->getRows($sql));
        $totalFiltered = $totalData; 
      ...
      /*
       ...
       print_r($totalData1);*/
        ...
        foreach ($totalData1 as $key => $value) {
            ...
            $outputData[] = '<a href="javascript:;" title="Email('.$value[$index_column].')" class="btn btn-primary  mail" data-id="'.$value[$index_column].'"><i class="icon-envelope"></i> </a> <a href="javascript:;" title="Print('.$value[$index_column].')" class="btn btn-warning  print" data-id="'.$value[$index_column].'"><i class="icon-print"></i> </a> <a href="javascript:;" title="Delete('.$value[$index_column].')" class="btn btn-danger delete" data-id="'.$value[$index_column].'"><i class="icon-trash"></i> </a>';
            $data[] = $outputData;
        }
       $json_response = array(
            "draw" => intval($_REQUEST['draw']),
 ...
 public function generateDatatableHotel($sql, $columns, $index_column=""){
        $totalData = count($this->getRows($sql));
        $totalFiltered = $totalData; 
      ...
      /*
       ...
       print_r($totalData1);*/
        ...
        foreach ($totalData1 as $key => $value) {
            ...
            $outputData[] = ' <a href="javascript:;" title="Approve('.$value[$index_column].')" class="btn btn-default approve" data-id="'.$value[$index_column].'"><i class="icon-check"></i> </a>';
            $data[] = $outputData;
        }
       $json_response = array(
            "draw" => intval($_REQUEST['draw']),
