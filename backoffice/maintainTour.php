...
<head>
<meta charset="utf-8">
<title>Maintain Tour Arrival & Departure - Admin Panel</title>
        ...
        <div class="span12">
		  <div class="widget">
	      			...
	      			<div class="widget-header">
	      				<i class="icon-gift"></i>
	      				<h3>Maintain Tour Arrival & Departure</h3>
	  				</div> <!-- /widget-header -->
                      ...
                      <form id="form"  class="form-horizontal">
									<fieldset>
										...
										<div class="control-group">											
											<label class="control-label" for="dest_id">Tour</label>
											<div class="controls">
												<select  class="span6 form-control" name="dest_id" id="dest_id"  ></select>
												<input type="hidden" class="span6 form-control" name="tour_id" id="tour_id" >
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										
										<div class="control-group">											
											<label class="control-label" for="arrival">Arrival Destination</label>
											<div class="controls">
												<input type="text" class="span6 form-control" name="arrivalid" id="arrivalid"  >
											
											</div> <!-- /controls -->				
										</div>
										<div class="control-group">                     
                      <label class="control-label" for="departure">Departure Destination</label>
                      <div class="controls">
                        <input type="text" class="span6 form-control" name="departure" id="departure"  >
