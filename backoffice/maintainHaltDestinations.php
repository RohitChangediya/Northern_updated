...
<head>
<meta charset="utf-8">
<title>Maintain Night Halt Destinations - Admin Panel</title>
        ...
        <div class="span12">
		  <div class="widget">
	      			...
	      			<div class="widget-header">
	      				<i class="icon-road"></i>
	      				<h3>Maintain Night Halt  Destinations</h3>
	  				</div> <!-- /widget-header -->
                      ...
                      <form id="form" class="form-horizontal">
									<fieldset>
										...
										<div class="control-group">											
											<label class="control-label" for="firstname">Destination Name</label>
											<div class="controls">
												<input type="text" class="span6 form-control" name="destination" id="destination" >
												<input type="hidden" class="span6 form-control" name="dest_id" id="dest_id" >
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
