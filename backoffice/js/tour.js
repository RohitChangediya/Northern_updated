var tour_crud = function() {
	...
	fetchdest();
      ...
      clearFields();
        ...
        if( $("#dest_id").val()=="") {
        $("#dest_id").focus();
        alert("Please Select valid tour destination.....!");
        return;
       }
	     if( $("#arrivalid").val()=="") {
	     	$("#arrivalid").focus();
	     	alert("Please Enter valid arrival destination.....!");
	     	return;
	     }
	      if( $("#departure").val()=="") {
        $("#departure").focus();
        alert("Please Enter valid departure destination.....!");
        return;
       }
...
$("#tour_id").val($resp[0].tour_id);
 $("#dest_id").val($resp[0].dest_id);
$("#arrivalid").val($resp[0].arrival_dest);
$("#departure").val($resp[0].departure_dest);
