...
<head>
<meta charset="utf-8">
<title>Maintain Hotels - Admin Panel</title>
                      ...
                      <form id="form"  class="form-horizontal">
									<fieldset>
										...
										<div class="control-group">											
											<label class="control-label" for="firstname">Hotel Name</label>
											<div class="controls">
												<input type="text" class="span6 form-control" id="hotelname" name="hotelname" >
                        <input type="hidden" class="span6 form-control" name="hotel_id" id="hotel_id" >
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
...
<div class="control-group">											
                                            ...
                                            <div class="controls">
                                              <div class="btn-group">
                                            <select class="span6  form-control" id="halt_id" name="halt_id" >
...
<div class="control-group">											
											<label class="control-label" for="radiobtns">Hotel Type</label>
											
                                            <div class="controls">

                                              <div class="btn-group">
                                            <select  class="span6 form-control" id="hoteltype" name="hoteltype" >
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="span6 form-control" id="contact" name="contact">
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="span4 form-control" id="address" name="address" >
											</div> <!-- /controls -->				
										</div> 
<div class="control-group">											
											<label class="control-label" for="email"> Username</label>
											<div class="controls">
												<input type="text" class="span4 form-control" id="username" name="username" >
											</div> <!-- /controls -->				
										</div> 
<div class="control-group">											
											<label class="control-label" for="email"> Password</label>
											<div class="controls">
												<input type="text" class="span4 form-control" id="password" name="password" >
											</div> <!-- /controls -->				
										</div> 
                                        ...
                                        <div class="control-group">											
                                            ...
                                            <label class="radio inline">
                                              <input type="radio" value='1' class="status" name="status"> Active
                                            </label>
                                            
                                            <label class="radio inline">
                                              <input type="radio" value='0' class="status" name="status"> Disabled
                                            </label>
                                          </div>	<!-- /controls -->			
										</div> <!-- /control-group -->
