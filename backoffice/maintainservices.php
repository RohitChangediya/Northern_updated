...
<head>
<meta charset="utf-8">
<title>Maintain Services - Admin Panel</title>
                      ...
                      <form id="form"  class="form-horizontal">
									<fieldset>
										...
										<div class="control-group">											
											<label class="control-label" for="firstname">Service</label>
											<div class="controls">
												<input type="text" class="span6 form-control" name="service" id="service"  >
												<input type="hidden" class="span6 form-control" name="serv_id" id="serv_id" >
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										  <div class="control-group">                     
                      <label class="control-label" for="firstname">On Season Costing</label>
                      <div class="controls">
                        <input type="text" class="span6 form-control" name="costing" id="costing"  >
										 ...
										 <div class="control-group">                     
                      <label class="control-label" for="firstname">Off Season Costing</label>
                      <div class="controls">
