    ...
    <div class="col-md-12">
        <div class="portlet box blue">
            <div class="portlet-title">
              <button class='btn btn-success btn-round btn-add-client'><i class='material-icons'></i> Add New Tour Image<div class='ripple-container'></div></button><br><br>
                <div class="tools">
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <form role="form" id ="form"  method="post" enctype="multipart/form-data">
                    <input type='hidden' class="form-control" name='img_id' id="img_id">
...
<script type="text/javascript" src="js/TourImages.js"></script>
<script>
