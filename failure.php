...
If (isset($_POST["additionalCharges"])) {
       ...
       if ($hash != $posted_hash) {
         ...
         echo "Your order status is ". $status .".<br>";
         echo "Your transaction id for this transaction is ".$txnid.". You may try making the payment by clicking the link below.<br>";
          
		 } 
?>
<!--Please enter your website homepagge URL -->
<p><a href=http://localhost/travel/payment.php> Try Again</a></p>
